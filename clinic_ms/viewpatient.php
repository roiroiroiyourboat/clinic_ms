<?php 
    ...
    if($_SERVER['REQUEST_METHOD']=='GET'){
        ...
        do{
            if(empty($id) || empty($stud_id) || empty($name) || empty($course) || empty($age) || empty($sex) || empty($temp) ||
            ...
            /*$sql = "UPDATE add_patient ".
                    ...
                    "WHERE id=$id";*/
                    $sql="update add_patient set id='$id', student_id='$stud_id', name='$name', course='$course', age='$age', sex='$sex', 
    ...
    <div class="container">
        ...
        <div class ="container d-flex justify-content-center">
            ...
            <input type="hidden" name="id" value="<?php echo $id;?>">
                ...
                <div class="btn">
                    <button type="button" class="btn btn-primary"><a href="print.php" style="text-decoration: none; color:white">Print</a></button>
