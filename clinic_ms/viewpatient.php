            ...
            <input type="hidden" name="id" value="<?php echo $id;?>">
                <div class="row">
                    <div class="col">
                        ...
                        <input type="number" class="form-control" name="stud_id" value="<?php echo $stud_id;?>">
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <select name="pos" class="form-control">
                                ...
                                <option value="<?php echo $position;?>">Faculty</option>
                                <option value="<?php echo $position;?>">Student</option>
                                <option value="<?php echo $position;?>">Staff</option>
                                <option value="<?php echo $position;?>">Other</option>
                            </select>
                    </div>
                    <div class="col">
                        ...
                        <select name="course" class="form-control">
                                <option value="<?php echo $course;?>">BSIT</option>
                                <option value="<?php echo $course;?>">BIT</option>
                                <option value="<?php echo $course;?>">BSDS</option>
                                <option value="<?php echo $course;?>">BSBA</option>
                                <option value="<?php echo $course;?>">BSED</option>
                            </select>
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <label for="form-label">Diagnosis:</label>
                        <input type="text" class="form-control" name="ill" value="<?php echo $ill;?>">
                    </div>
                    <div class="col">
                        <label for="form-label">Temperature:</label>
                        <input type="number" class="form-control" name="temp" value="<?php echo $temp;?>"> 
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col">
                        <label for="form-label">Weight(kg):</label>
                    ...
                    <div class="col">
                        ...
                        <input type="number" class="form-control" name="bp" value="<?php echo $bp;?>">
                    </div>
                </div>
                <br>
                <div class="btn">
