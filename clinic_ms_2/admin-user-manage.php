...
<head>
    ...
    <link rel="stylesheet" href="admin-user-m.css">
    <!--Boxicons link-->
                ...
                <tbody class="table-group-divider">
                    ...
                    <?php
                        ...
                        if(isset($_GET["search"])) {
                            ...
                            if($row = $result-> fetch_assoc()){
                                ...
                                <td>
                                    ...
                                    <a class='btn btn-primary btn-sm' href='admin-user-manage.php?deleteid=$id'><i class='bi bi-eye'></i></a>
                                </td>
                                </tr>";
                            } else {
                                ?>
                        ...
                        while($row = $result-> fetch_assoc()){
                            ...
                            <td>
                                <a class='btn btn-primary btn-sm' href='viewuser.php?updateid=$id'><i class='bi bi-eye'></i></a>
                                <a class='btn btn-danger btn-sm' href='del-user.php?deleteid=$id'><i class='bx bx-trash'></i></a>
                            </td>
                            </tr>";
                        }
                    } 
