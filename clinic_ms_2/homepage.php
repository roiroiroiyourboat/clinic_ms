...
<html>
    <head>
        ...
        <title>BulSU-SC Infirmary | Login</title>
    ...
    <body>
                ...
                <div class="form sign_form">
                    ...
                    <form action="config.php" method="post">
                        ...
                        <div id="captchaContainer">
                            <label for="for-label">CAPTCHA:</label>
        ...
        <script>
            ...
            function handleFormSubmission(event) {
                ...
                // Get user input and CAPTCHA text
                ...
                if (userCaptchaInput === captchaText) {
                    ...
                    document.getElementById('message').innerText = 'CAPTCHA mismatch. Please try again.';

                    document.getElementById('message').style.color = 'red';
                 }
                }

                // Initialize CAPTCHA and form submission event listener
                function init() {
